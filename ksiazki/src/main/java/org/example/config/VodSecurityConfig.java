    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(request->request
                        .requestMatchers(HttpMethod.POST, "/webapi/ksiazki").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/webapi/ksiegarnie").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/webapi/ksiegarnie/**").authenticated()
